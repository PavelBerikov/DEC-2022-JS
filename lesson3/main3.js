...
/*- За допомогою циклу for і document.write() вивести 10 блоків div c довільним текстом і індексом всередині*!/*/
{
    ...
    document.write(`<div>Lorem ipsum dolor. ${a[b].name} </div>`)
    }
}
/*- За допомогою циклу while вивести в документ 20 блоків h1 c довільним текстом всередині.*!/*/
{
    let a = 0;
    while (a < 20) {
    document.write(`<div><h1>Lorem ipsum dolor.</h1></div>`);
    a++
}
...
- За допомогою циклу while вивести в документ 20 блоків h1 c довільним текстом і індексом всередині.*/
{
    ...
    while (b < a.length) {
        ...
        document.write(`<h1>Lorem ipsum. ${a[b].name}</h1>`);
        b++
    }
...
- користувачів які старші за 30 років-->*/
{
    ...
    for (let i = 0; i < users.length; i++) {
        let st = users[i].status;
        switch (st) {
            case true:
                document.write(`<div><h3>${users[i].name} -  ${users[i].status}</h3></div>`)
                break;
        }
    ...
    for (let i = 0; i < users.length; i++) {
        let ag = users[i].age;
       if (ag > 30) {
           document.write(`<div><h3>${users[i].name} -  ${users[i].age}</h3></div>`)
       }
